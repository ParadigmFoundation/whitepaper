...
\noindent The full integral can be simplified to
...
\begin{itemize}
  \item Input: \\ $\alpha =$ quantity of Ether deposited \\
  \item Output: \\ $\beta =$ quantity of KOSU received \\
  \item Quantities necessary for parameterization (result of read to contract system state): \\ $j =$ KOSU supply \\ $b = $ total quantity of Ether collateral \\ $p =$ price of KOSU at $j$
  \item Then: \\
  \begin{equation}
...
\begin{itemize}
  \item Input: \\ $\beta =$ quantity of KOSU deposited \\
  \item Output: \\ $\alpha =$ quantity of Ether received \\
  \item Quantities necessary for parameterization (result of read to contract system state): \\ $j =$ KOSU supply \\ $b = $ total quantity of Ether collateral \\ $p =$ price of KOSU at $j$
  \item Then: \\
  \begin{equation}
...
\\\texttt{http://bit.ly/tendermint-node-spec}
...
\\\small\texttt{https://bit.ly/tendermint-thesis}
