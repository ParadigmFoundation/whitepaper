...
\begin{itemize}
  ...
  \item \texttt{Voting} - an implementation contract that manages challenges/votes for the \texttt{ValidatorRegistry} contract. Implements a basic commit-reveal voting scheme.
\end{itemize}
