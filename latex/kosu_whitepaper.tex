...
\noindent The validity of Order transactions is based solely on the signature of the poster that submitted the order to the network, and some basic data structure 
...
\noindent The Kosu network uses a bonded proof-of-stake security model wherein validators lock (also called bonding) tokens in a contract proportional to the amount of vote poer // TODO, rephrase
...
\noindent Poster bonding is the sybil tolerance mechanism used...
\bigskip

\subsubsection{Validator elections}\label{incentive-models-val-elections}
\noindent During curation processes, voters can...
\bigskip

\subsubsection{Validator rewards}\label{incentive-models-val-rewards}
\noindent Validators can specify a reward in Kosu tokens... // cover burn case
\bigskip
...
\section{Future Work}\label{token-distribution}
